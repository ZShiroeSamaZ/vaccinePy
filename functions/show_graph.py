...
def show_graph(seleted_graph):
    if seleted_graph == 1:
        ...
        ax = df.plot(x ='age', y='counts', kind = 'bar')
        ax.set_xlabel("Age (years)")
        ax.set_ylabel("Amount of people")
        for container in ax.containers:
            ax.bar_label(container)
        plt.title("Amount of people of Registrants in the same age.")
        plt.show()
        ...
        ax = df.plot(x ='date', y='counts', kind = 'bar')
        ax.set_xlabel("Date")
        ax.set_ylabel("Amount of people")
        for container in ax.containers:
            ax.bar_label(container)
        ...
        ax = data.pivot(index='location', columns='Vaccine name', values='counts').plot(kind='bar')
        ax.set_xlabel("Hospital Name")
        ax.set_ylabel("Amount of vaccine")
        for container in ax.containers:
            ax.bar_label(container)
        ...
        ax = vaccine.plot(x ='first dose', y='counts', kind = 'bar')
